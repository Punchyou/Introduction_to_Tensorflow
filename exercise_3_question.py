...
#create a callbacks class for cancelling the training if a desired value of accuracy is reached
...
#reshape and normalize tha images
...
#illustrate the summary of the training
model.summary()
